...
public class Login extends ActivityBase implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        usuarioPush.setCodRubro01(((Rubro01)dynamicSpinner.getSelectedItem()).getId());
    ...
    private boolean puedoIngresar(){
        ...
        if(dynamicSpinner.getSelectedItem()==null){
            Toast.makeText(this, "Seleccione tipo de usuario", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private boolean registroServidor(){
        ...
        try
        {
            ...
            registro.put("idTipo", usuarioPush.getCodRubro01());
